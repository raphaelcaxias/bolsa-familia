...
/* Cards KPIs - Layout fixo sem cortes */
.kpi-grid {
    display: flex;
    gap: 20px;
...
# ============================================================
def fmt_brl(valor):
    """Formata valor em reais - SEM CORTES"""
    if pd.isna(valor) or valor == 0:
        return "R$ 0"
    if abs(valor) >= 1_000_000_000:
        bilhoes = valor / 1_000_000_000
        return f"R$ {bilhoes:.1f}B".replace(".", ",")
    if abs(valor) >= 1_000_000:
        milhoes = valor / 1_000_000
        return f"R$ {milhoes:.1f}M".replace(".", ",")
...
<div style="margin-bottom: 20px;">
    <h1 style="color: #1A2B4C; font-size: 28px; margin: 0;">📊 CNPq Analytics</h1>
    <p style="color: #6B7A8F; font-size: 15px; margin-top: 8px;">Análise estratégica de investimentos em pesquisa e desenvolvimento no Brasil</p>
</div>
""", unsafe_allow_html=True)
...
"""
    ...
    st.markdown("""
    <div style="background:#FFFFFF; border-radius:16px; padding:30px; margin-top:20px; border:1px solid #E8ECF0;">
        <h3 style="color:#1A2B4C;">📋 Sobre o Dashboard</h3>
        ...
        <h4 style="color:#1A2B4C; margin-top:20px;">🚀 Funcionalidades</h4>
        <ul>
            <li>✅ Filtros interativos por região, período e área</li>
            <li>✅ Gráficos dinâmicos com Plotly</li>
            <li>✅ Rankings e análise de evolução temporal</li>
            <li>✅ Exportação em CSV e relatório TXT</li>
        </ul>
        
        <h4 style="color:#1A2B4C; margin-top:20px;">📥 Como começar</h4>
        <ol>
